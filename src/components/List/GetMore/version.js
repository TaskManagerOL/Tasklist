const updateData = [{
    ...
    bug: [],
    optimize: [],
    update: ["Tasklist从9月3号起可以简易使用，此版本所有任务存储在本地。","此版本无法适配移动端。","此版本无法第三方登录，无法注册，无法找回密码，登录功能只是能使用，与Tasklist的基础功能并不挂钩。","此版本所有数据只是保存到本地，cookie被清除后所有任务将会被清除。","数据是不安全的，请不要在这里写很重要的数据。"]
},{
    version: "0.1.1",
    date: "2023.11.12",
